...
IMPLS = ada ada.2 awk bash basic bbc-basic c chuck clj-mal clojure coffee common-lisp cpp crystal cs d dart \
...
clj-mal_STEP_TO_PROG            = impls/clj-mal/target/$($(1)).jar
